...
<div class="panel panel-primary">
    <div class="panel-heading">   <h4><font color="#FFFF00">ตรวจสอบ แฟ้ม NUTRITION</font></h4></font></h4>
...
<?php echo Html::a('ตรวจสอบบัญชี 4', ['nutrition/nutri4'], ['class' => 'btn btn-warning']); ?> 
<?php echo Html::a('ตรวจสอบบัญชี 5', ['nutrition/nutri5'], ['class' => 'btn btn-warning']); ?>  <br>
