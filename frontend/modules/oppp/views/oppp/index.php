...
<div class="panel panel-primary">
    <div class="panel-heading"> <h4><font color="#FFFF00">โครงสร้างมาตรฐานข้อมูลด้านสุขภาพกระทรวงสาธารณสุข 43 แฟ้ม</font></h4></font></h4>
   <h6><p><font color="#FFFFFF">อ้างอิงจากคู่มือการปฏิบัติงานการจัดเก็บและจัดส่งข้อมูลตามโครงสร้างมาตรฐานข้อมูลด้านสุขภาพกระทรวงสาธารณสุข Version 2.0 (1 ตุลาคม 2557)ปีงบประมาณ 2558</font></p></h6>
    <span class="label label-success"><span class="glyphicon glyphicon-ok"></span> สามารถตรวจสอบได้</span>
    <span class="label label-danger"><span class="glyphicon glyphicon-remove"></span> ยังไม่สามารถตรวจสอบได้</span> 
    </div>
</div>
