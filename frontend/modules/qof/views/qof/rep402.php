...
<div class="panel panel-primary">
    <div class="panel-heading"><h4><font color="#FFFF00">เด็กนักเรียน ป. 1 ได้รับการตรวจช่องปาก (ผู้รับผิดชอบ นัชฒภัทร ปานอำพัน)</font></h4>
    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model){
                return  Html::a(Html::encode($model['b']),['/qof/qof/goal402' ,'id'=>$model['village_school_id']]);
            }// end value
        ],
        [
            'label' => 'ผลงาน  (คน)',
            ...
            'value' => function($model) use($date1,$date2){
                return  Html::a(Html::encode($model['a']),['/qof/qof/result402' ,'id'=>$model['village_school_id'], 'date1' => $date1, 'date2' => $date2]);
            }// end value
        ]
    ]
]);
